...
class OpenAIChatTransport:
    ...
    def __init__(
        ...
        *,
        ...
        rotate_on_failure: Callable[[BaseException], Awaitable[bool]] | None = None,
    ) -> None:
        self._client = client
        ...
        self._rotate_on_failure = rotate_on_failure
        ...
        *,
        ...
        while execution.can_attempt:
            ...
            try:
                ...
                if self._rotate_on_failure is not None:
                    await self._rotate_on_failure(error)
    ...
    async def _run_execution(
        ...
        while True:
            ...
            try:
                ...
                rotate = self._transport._rotate_on_failure
