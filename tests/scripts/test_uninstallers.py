...
if [ "${1:-}" = "tool" ] && [ "${2:-}" = "uninstall" ]; then
    ...
    for name in fcc-desktop fcc-server fcc-claude fcc-codex fcc-pi fcc-opencode fcc-cline fcc-hermes fcc-dsh fcc-grok fcc-muse fcc-aider fcc-update fcc-init free-claude-code; do
